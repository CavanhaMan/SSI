...
public class EstruturaDeDados {
	...
	private static void trabalhandoComMap() {
		...
		System.out.println("__________________________");
		faltas.entrySet().forEach(System.out::println);
	...
	private static void trabalhandoComList() {
		...
		System.out.println(lista.size());
		System.out.println(lista.get(2)); //imprime o valor na posição 2
		System.out.println("__________________________");
		System.out.println(lista);
		
		Collections.sort(lista);	// ordena a lista
		System.out.println(lista.get(2)); //o valor na posição 2 foi alterado devido à ordenação
		System.out.println(lista);
		...
		lista.remove(2);	//remove o item na posição 2
		...
		//crio uma lista nova com todo o conetúdo do conjunto
	...
	private static void trabalhandoComSet() {
		...
		if (conjunto.add(1))
			...
			System.out.println("Já existe este número lá!");

		conjunto.add(100);
		conjunto.add(1);
		conjunto.add(200);
		conjunto.add(200);// nao aceita repetição!!
		conjunto.add(200);
		conjunto.add(200);
		conjunto.add(200);
		conjunto.add(200);
		...
		//se existe o valor "1" pra remover no grupo e conseguir remover (o retorno é booleano)
