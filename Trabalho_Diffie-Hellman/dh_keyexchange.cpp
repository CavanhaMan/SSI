...
/*
Enter the values of p and g upon which Alice And Bob both will aggree :
17
23
Enter the Secret Integer for Alice : 3
Enter the Secret Integer for Bob : 7

Alice's private key, known only to Alice : 12
Bob's private key known only to Bob : 14

Alice's public key, known to Alice and Bob : 7
Bob's public key, known to Alice and Bob : 7
